  ...
  return (
    <div className='flex flex-col p-5 m-5 h-max border border-gray-300 space-y-6 rounded-lg shadow-md'>
      ...
      <div>
        ...
        <button type="button" className='w-full p-4 rounded-md text-white bg-gradient-to-r from-blue-700 to-pink-400 sm:p-2 sm:w-max focus:outline focus:outline-blue-500 focus:outline-offset-2'>Add to Cart</button>
      </div>
    </div>
  )
}
