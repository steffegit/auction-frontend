    ...
    <footer className="bg-gray-800 text-white">
      ...
      <div className="flex flex-col text-center justify-center py-6 px-4 bg-gray-700">
        <div class="flex mb-4 justify-center space-x-4">
          ...
          <a href="#" class=" hover:bg-[#E1306C] rounded-full p-2">
            <svg
              class="w-8 h-8"
              fill="currentColor"
              viewBox="0 0 24 24"
          ...
          <a href="#" class=" hover:bg-[#1DA1F2] rounded-full p-2">
            <svg
              class="w-8 h-8"
              fill="currentColor"
              viewBox="0 0 24 24"
          ...
          <a href="#" class=" hover:bg-[#333] rounded-full p-2">
            <svg
              class="w-8 h-8"
              fill="currentColor"
              viewBox="0 0 24 24"
          ...
          <a href="#" class=" hover:bg-[#f1802d] rounded-full p-2">
            <svg
              class="w-8 h-8"
              fill="currentColor"
              viewBox="0 0 24 24"
