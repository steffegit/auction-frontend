  ...
  return (
    <footer className="bg-gray-800 text-white mt-10">
      ...
      <div className="flex flex-col text-center justify-center items-center py-6 px-4 bg-gray-700">
        <div className="flex mb-4 space-x-2 sm:space-x-4">
          <a
          ...
          <a
            href="https://github.com/CodexDevv"
            target="_blank"
            className="hover:bg-[#E1306C] rounded-full p-2"
          >
            <svg
              className="w-8 h-8"
              fill="currentColor"
          ...
          <a
            href="https://github.com/CodexDevv"
            target="_blank"
            className=" hover:bg-[#333] rounded-full p-2"
          >
            <svg
              className="w-8 h-8"
              fill="currentColor"
          ...
          <a
            href="https://github.com/CodexDevv"
            target="_blank"
            className=" hover:bg-[#f1802d] rounded-full p-2"
          >
            <svg
              className="w-8 h-8"
              fill="currentColor"
